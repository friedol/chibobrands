<?php $__env->startSection('title', 'Financial Analytics Report'); ?>
...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-4 no-print">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <div class="d-flex flex-wrap gap-2 justify-content-md-end">
                <a href="<?php echo e(route('admin.finance.daily-report')); ?>" data-no-global-handler data-no-preloader class="btn btn-outline-info btn-sm px-3 shadow-sm bg-white text-info fw-bold">
                    <i class="fas fa-calendar-day me-1"></i> Daily Summary
                </a>
                <a href="<?php echo e(route('admin.finance.balance-sheet')); ?>" data-no-global-handler data-no-preloader class="btn btn-outline-primary btn-sm px-3 shadow-sm bg-white text-primary fw-bold">
    ...
    ?>
    <div class="collapse <?php echo e($filterHasValues ? 'show' : ''); ?> mb-4 no-print" id="filterCollapse">
        <div class="card border-0 shadow-sm border-top border-4 border-primary">
            <div class="card-body bg-light p-3">
                <form action="<?php echo e(route('admin.finance.reports')); ?>" method="GET" class="row g-2 align-items-end" data-no-global-handler>
                    <div class="col-12 col-md-3">
                        ...
                        <select name="period" id="periodSelect" class="form-select form-select-sm">
                            ...
                            <option value="month" <?php echo e(($period ?? 'month') == 'month' ? 'selected' : ''); ?>>This Month</option>
                            <option value="year" <?php echo e(($period ?? '') == 'year' ? 'selected' : ''); ?>>This Year</option>
                            <option value="customer_range" <?php echo e(($period ?? '') == 'customer_range' ? 'selected' : ''); ?>>Customer Date Range</option>
                        </select>
                    </div>
                    ...
                    <div class="col-6 col-md-2 customer-date-group <?php echo e(($period ?? '') == 'customer_range' ? '' : 'd-none'); ?>">
                        <label class="form-label fw-bold x-small text-uppercase mb-1">From Date</label>
                        <input type="date" name="customer_date_from" class="form-control form-control-sm" value="<?php echo e(request('customer_date_from')); ?>">
                    </div>
                    <div class="col-6 col-md-2 customer-date-group <?php echo e(($period ?? '') == 'customer_range' ? '' : 'd-none'); ?>">
                        <label class="form-label fw-bold x-small text-uppercase mb-1">To Date</label>
                        <input type="date" name="customer_date_to" class="form-control form-control-sm" value="<?php echo e(request('customer_date_to')); ?>">
                    </div>

                    <div class="col-12 col-md-auto ms-md-auto">
                        <div class="btn-group shadow-sm w-100">
                            <button type="submit" class="btn btn-primary btn-sm px-4 fw-bold">APPLY</button>
                            <a href="<?php echo e(route('admin.finance.reports')); ?>" class="btn btn-dark btn-sm px-4 fw-bold">RESET</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-center border-bottom pb-3">
            <div>
                ...
                <h2 class="fw-bold text-dark mt-2 mb-1">
                    <?php echo e($currentDept ? $currentDept->name . ' - ' : ''); ?>Financial Performance Report
                </h2>
                <p class="mb-0 text-muted">Scope: <?php echo e($currentDept ? 'Departmental Analysis' : 'Consolidated Group Report'); ?></p>
                <p class="mb-0 text-muted">Period: <?php echo e(\Carbon\Carbon::parse($dateFrom)->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($dateTo)->format('M d, Y')); ?></p>
                <?php
                    $custFrom = request('customer_date_from');
                    $custTo = request('customer_date_to');
                ?>
                <?php if($custFrom || $custTo): ?>
                    <p class="mb-0 text-muted small">
                        Customers Added: <?php echo e($custFrom ? \Carbon\Carbon::parse($custFrom)->format('M d, Y') : '...'); ?> -
                        <?php echo e($custTo ? \Carbon\Carbon::parse($custTo)->format('M d, Y') : '...'); ?>
            ...
            <div class="text-end text-dark">
                ...
                <p class="mb-1 small">Generated: <?php echo e(now()->format('M d, Y H:i')); ?></p>
                <p class="mb-0 small">Ref: FIN-<?php echo e(now()->format('Ymd')); ?>-<?php echo e($currentDept ? $currentDept->id : 'ALL'); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="col-6 col-md-4 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-info">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-info"><?php echo e(number_format($totalBilled ?? 0)); ?></div>
        ...
        <div class="col-6 col-md-4 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-primary">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-dark"><?php echo e(number_format($totalRevenue)); ?></div>
        ...
        <div class="col-6 col-md-4 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-success">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-dark"><?php echo e(number_format($deposited)); ?></div>
        ...
        <div class="col-6 col-md-4 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4" style="border-left-color: #20c997 !important;">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold" style="color: #20c997;"><?php echo e(number_format($debtCollected ?? 0)); ?></div>
        ...
        <div class="col-6 col-md-4 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-warning">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-dark"><?php echo e(number_format($balanceDue ?? 0)); ?></div>
        ...
        <div class="col-6 col-md-6 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-danger">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-dark"><?php echo e(number_format($spent)); ?></div>
        ...
        <div class="col-6 col-md-6 col-lg">
            <div class="card border-0 shadow-sm h-100 card-metric border-start border-4 border-dark">
                <div class="card-body p-3">
                    ...
                    <div class="h4 mb-0 fw-bold text-dark"><?php echo e(number_format($balance)); ?></div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $deptWise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e((request('department_id') == $dept['id']) ? 'bg-primary bg-opacity-10' : ''); ?>">
                                    <td class="ps-2 py-2">
                                        <div class="fw-bold"><?php echo e($dept['name']); ?></div>
                                        <a href="?department_id=<?php echo e($dept['id']); ?>&period=<?php echo e($period); ?>" class="x-small text-decoration-none no-print"><i class="fas fa-eye me-1"></i>Focus</a>
                                    </td>
                                    <td class="text-end text-success py-2"><?php echo e(number_format($dept['collected'])); ?></td>
                                    <td class="text-end text-warning py-2"><?php echo e(number_format($dept['credited'])); ?></td>
                                    <td class="text-end fw-bold text-dark py-2"><?php echo e(number_format($dept['total_revenue'])); ?></td>
                                    <td class="text-end text-danger low-font py-2"><?php echo e(number_format($dept['expenses'])); ?></td>
                                    <td class="text-end pe-2 fw-bold py-2 <?php echo e(($dept['collected'] - $dept['expenses']) >= 0 ? 'text-primary' : 'text-danger'); ?>">
                                        <?php echo e(number_format($dept['collected'] - $dept['expenses'])); ?>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $sellerWise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item px-3 py-2 border-0 border-bottom">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="fw-bold text-dark"><?php echo e($seller['name']); ?></span>
                                <span class="badge bg-primary rounded-pill">TZS <?php echo e(number_format($seller['total_revenue'])); ?></span>
                            </div>
                            <div class="row g-0 x-small">
                                <div class="col-6">
                                    <span class="text-success fw-bold">Collected:</span> 
                                    <span class="text-muted"><?php echo e(number_format($seller['collected'])); ?></span>
                                </div>
                                <div class="col-6 text-end">
                                    <span class="text-danger fw-bold">Uncollected:</span> 
                                    <span class="text-muted"><?php echo e(number_format($seller['credited'])); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4 small text-muted"><?php echo e($tx->date->format('d M, Y')); ?></td>
                                    <td>
                                        <div class="fw-bold small"><?php echo e($tx->customer->name ?? 'Direct Payment'); ?></div>
                                        <div class="x-small text-muted">Ref: <?php echo e($tx->id); ?></div>
                                    </td>
                                    <td><span class="badge bg-light text-dark border"><?php echo e($tx->department->name ?? 'POS'); ?></span></td>
                                    <td class="small"><?php echo e(ucfirst(str_replace('_', ' ', $tx->payment_method))); ?></td>
                                    <td class="text-end pe-4 fw-bold text-success">+<?php echo e(number_format($tx->amount)); ?></td>
                                </tr>
    ...
    <div class="print-only print-footer">
        <div class="row align-items-center mb-1">
            <div class="col-8 text-start">
                <p class="mb-0 x-small text-muted">&copy; <?php echo e(date('Y')); ?> CHIBOBRAND. Confidential Document.</p>
            </div>
            <div class="col-4 text-end">
                <p class="mb-0 small"><b>Printed by:</b> <?php echo e(auth()->user()->name); ?></p>
            </div>
        </div>
        <div class="text-center">
            <p class="mb-0 x-small text-muted">Developer: Fridoltech | Generated: <?php echo e(now()->format('M d, Y H:i')); ?></p>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        trendChart = new Chart(ctxTrend, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Cash In',
                        data: <?php echo json_encode($chartData['income'], 15, 512) ?>,
                        borderColor: '#198754',
    ...
    const deptWise = <?php echo json_encode($deptWise, 15, 512) ?>;
    new Chart(ctxPie, {
        type: 'doughnut',
        data: {
    ...
    window.onbeforeprint = () => { document.title = "Finance_Report_<?php echo e($currentDept ? $currentDept->name : 'Consolidated'); ?>_<?php echo e(now()->format('Ymd')); ?>"; };
});
</script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/admin/finance/reports.blade.php ENDPATH**/ ?>