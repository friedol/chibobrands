                ...
                <div class="col-6 col-md-3 col-lg-2 stats-col">
                    <div class="card shadow-sm h-100 border-0 border-start border-4 border-danger hover-lift">
                        <div class="card-body p-3">
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e(number_format($taskStats['loss'])); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 col-lg-2 stats-col">
                    <div class="card shadow-sm h-100 border-0 border-start border-4 border-dark hover-lift" style="border-left-color: #1e293b !important;">
                        <div class="card-body p-3">
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e(number_format($taskStats['cancelled'])); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Desktop/LaravelProject/chibo_sales/resources/views/admin/design-tasks/index.blade.php ENDPATH**/ ?>