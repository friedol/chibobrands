    ...
    <div class="register-card">
        <div class="register-card-inner">
            <div class="register-content">
                ...
                <!-- Register Form -->
                <form method="POST" action="<?php echo e(route('customer.register')); ?>" class="register-form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <option value="retail" <?php echo e(old('business_type') == 'retail' ? 'selected' : ''); ?>>Retail Store</option>
                                            <option value="wholesale" <?php echo e(old('business_type') == 'wholesale' ? 'selected' : ''); ?>>Wholesale Distributor</option>
                                            <option value="printing" <?php echo e(old('business_type') == 'printing' ? 'selected' : ''); ?>>Printing Company</option>
                                            <option value="advertising" <?php echo e(old('business_type') == 'advertising' ? 'selected' : ''); ?>>Advertising Agency</option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   name="is_wholesale" 
                                                   value="1" 
                                                   <?php echo e(old('is_wholesale') ? 'checked' : ''); ?>>
                ...
                <div class="login-link">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="signin-btn">
...
<?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/customer/auth/register.blade.php ENDPATH**/ ?>