<?php $__env->startSection('title', 'Record Movement - Gatekeeper'); ?>
...
<div class="container-fluid p-3">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('gatekeeper.movements.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
        ...
        <?php $currentType = request('type', 'in'); ?>
        <div class="d-flex border rounded-pill overflow-hidden p-1 bg-white shadow-sm">
            <a href="<?php echo e(route('gatekeeper.movements.create', ['type' => 'in'])); ?>" 
               class="px-4 py-1 rounded-pill text-decoration-none fw-bold small transition-all <?php echo e($currentType == 'in' ? 'bg-success text-white shadow-sm' : 'text-muted'); ?>">
                <span data-i18n="incoming">INCOMING</span>
            </a>
            <a href="<?php echo e(route('gatekeeper.movements.create', ['type' => 'out'])); ?>" 
               class="px-4 py-1 rounded-pill text-decoration-none fw-bold small transition-all <?php echo e($currentType == 'out' ? 'bg-warning text-dark shadow-sm' : 'text-muted'); ?>">
                <span data-i18n="outgoing">OUTGOING</span>
            </a>
        </div>
    </div>

    <form action="<?php echo e(route('gatekeeper.movements.store')); ?>" method="POST" id="movementForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-white border-0 py-3">
                        <h6 class="fw-bold mb-0 text-dark">
                            ...
                            <span data-i18n="<?php echo e($currentType == 'in' ? 'origin_details' : 'dest_details'); ?>">
                                <?php echo e($currentType == 'in' ? 'Origin Details' : 'Destination Details'); ?>

                            </span>
                        </h6>
                    </div>
                    <div class="card-body">
                        <?php if($currentType == 'in'): ?>
                            <!-- Incoming Source -->
                            <div class="row g-3">
                                <div class="col-12">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <select name="recipient_type" class="form-select bg-light border-0 py-2" required>
                                        <option value="Customer" <?php echo e(request('recipient_name') ? 'selected' : ''); ?> data-i18n="opt_customer">Customer</option>
                                        <option value="Staff" data-i18n="opt_staff">Staff Member</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" id="recipient_name" name="recipient_name" class="form-control bg-light border-0 py-2" required placeholder="Receiver Name" data-i18n-placeholder="receiver_placeholder" value="<?php echo e(request('recipient_name')); ?>">
                                </div>
                                ...
                                <div class="col-12" id="customer_recipient_identifier_wrapper" style="display: none;">
                                    ...
                                    <input type="text" id="recipient_identifier" name="recipient_identifier" class="form-control bg-light border-0 py-2" placeholder="Phone or ID number" value="<?php echo e(request('recipient_identifier')); ?>">
                                </div>
            ...
            <div class="col-12 col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="product_name" class="form-control bg-light border-0 py-2" required placeholder="e.g. Mifuko" data-i18n-placeholder="item_placeholder" value="<?php echo e(request('product_name')); ?>">
                            </div>
                            <div class="col-6">
                                ...
                                <input type="number" name="quantity" class="form-control bg-light border-0 py-2" required min="1" value="<?php echo e(request('quantity', 1)); ?>">
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12">
                                ...
                                <select name="purpose" class="form-select bg-light border-0 py-2" required>
                                    ...
                                    <?php else: ?>
                                        <option value="Delivery" <?php echo e(request('purpose') == 'Delivery' ? 'selected' : ''); ?> data-i18n="opt_delivery_act">Delivery</option>
                                        <option value="Transfer" <?php echo e(request('purpose') == 'Transfer' ? 'selected' : ''); ?> data-i18n="opt_stock_trans">Stock Transfer</option>
                                        <option value="Repair" <?php echo e(request('purpose') == 'Repair' ? 'selected' : ''); ?> data-i18n="opt_repair">Sent for Repair</option>
                                        <option value="Official duty" <?php echo e(request('purpose') == 'Official duty' ? 'selected' : ''); ?> data-i18n="opt_official">Official Use</option>
                                    <?php endif; ?>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="authorization_reference" class="form-control bg-light border-0 py-2" placeholder="Optional" data-i18n-placeholder="optional_placeholder" value="<?php echo e(request('authorization_reference')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn <?php echo e($currentType == 'in' ? 'btn-success' : 'btn-warning text-dark'); ?> px-5 py-2 rounded-pill fw-bold shadow-sm" data-no-global-handler>
                            <i class="fas fa-check-circle me-2"></i> 
                            <span data-i18n="<?php echo e($currentType == 'in' ? 'confirm_in' : 'confirm_out'); ?>">
                                <?php if($currentType == 'in'): ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Pass PHP data to JS
        const staffUsers = <?php echo json_encode($staffUsers ?? [], 15, 512) ?>;
        const deliveryUsers = <?php echo json_encode($deliveryPersonnel ?? [], 15, 512) ?>;
        ...
        if (recipientCustomerSearchInput) {
            const customerSearchUrl = "<?php echo e(route('gatekeeper.customers.search')); ?>";
        ...
        const taskSearchUrl = "<?php echo e(route('gatekeeper.tasks.search')); ?>";
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/gatekeeper/create.blade.php ENDPATH**/ ?>