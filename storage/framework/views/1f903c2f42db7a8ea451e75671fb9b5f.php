<?php $__env->startSection('title', 'Finance Report - ' . ($isRange ? $carbonFrom->format('d M') . ' to ' . $carbonTo->format('d M, Y') : $carbonFrom->format('d M, Y'))); ?>
    ...
    <div class="row align-items-center mb-4 no-print">
        <div class="col-12">
            <div class="d-flex flex-row justify-content-between align-items-start mb-2 gap-2">
                <div class="flex-grow-1">
                    ...
                    <p class="text-muted small mb-0">
                        <?php if($isRange): ?>
                            Period: <?php echo e($carbonFrom->format('M d, Y')); ?> - <?php echo e($carbonTo->format('M d, Y')); ?>

                        <?php else: ?>
                            <?php echo e($carbonFrom->format('l, F d, Y')); ?>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('admin.finance.cash-flow')); ?>" data-no-global-handler data-no-preloader class="btn btn-outline-info btn-sm">
                ...
                <button class="btn btn-outline-primary btn-sm px-3 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#filterCollapse">
                    ...
                    <?php if(request()->anyFilled(['period', 'date_from', 'date_to'])): ?>
                        <span class="badge bg-primary ms-1">Active</span>
                    <?php endif; ?>
                </button>
                <a href="<?php echo e($pdfUrl); ?>" target="_blank" rel="noopener" class="btn btn-success btn-sm share-pdf-btn" data-pdf-url="<?php echo e($pdfUrl); ?>" data-pdf-filename="<?php echo e($pdfFilename); ?>" title="Share this report as PDF (email, messaging, etc.).">
        ...
        <div class="collapse <?php echo e(request()->anyFilled(['period', 'date_from', 'date_to']) ? 'show' : ''); ?> mb-4 no-print" id="filterCollapse">
            <div class="card border-0 shadow-sm border-top border-4 border-primary">
                <div class="card-body bg-light p-3">
                    <form action="<?php echo e(route('admin.finance.daily-report')); ?>" method="GET" class="row g-2 align-items-end" data-no-global-handler>
                        ...
                        <div class="col-12 col-md-auto ms-auto">
                            <div class="btn-group shadow-sm w-100">
                                ...
                                <a href="<?php echo e(route('admin.finance.daily-report')); ?>" class="btn btn-dark btn-sm px-4 fw-bold">RESET</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="print-only report-header">
            <div class="d-flex justify-content-between align-items-center mb-0">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(asset('images/logo.webp')); ?>" alt="Logo" style="height: 60px; margin-right: 20px;" onerror="this.style.display='none'">
                    <div>
                ...
                <div class="text-end">
                    ...
                    <p class="mb-0 fw-bold fs-5 text-dark text-uppercase">
                        <?php if($isRange): ?>
                            <?php echo e($carbonFrom->format('d M')); ?> - <?php echo e($carbonTo->format('d M Y')); ?>

                        <?php else: ?>
                            <?php echo e($carbonFrom->format('d M Y')); ?>

                        <?php endif; ?>
                    </p>
                    <p class="mb-0 x-small text-muted">Generated: <?php echo e(now()->format('M d, Y H:i')); ?></p>
                </div>
            </div>
                    ...
                    <table class="table table-bordered report-table align-middle shadow-sm">
                        <thead>
                            <tr class="header-row">
                                ...
                                <th style="width: 18%; text-align: left !important;"><?php echo e($dept->name); ?> TASK</th>
                            ...
                            <?php for($i = 0; $i < $maxItems; $i++): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="description-cell ps-3">
                                        <div class="fw-bold text-dark"><?php echo e($income['customer_name'] ?? ''); ?><?php if(isset($income['is_debt']) && $income['is_debt']): ?> (dept) <?php endif; ?></div>
                                    </td>
                                    <td class="description-cell ps-3 small text-muted"><?php echo e($income['description'] ?? ''); ?></td>
                                    <td class="amount-cell"><?php echo e($income && $income['mobile'] > 0 ? number_format($income['mobile'], 0) : ''); ?></td>
                                    <td class="amount-cell"><?php echo e($income && $income['cash'] > 0 ? number_format($income['cash'], 0) : ''); ?></td>
                                    <td class="amount-cell"><?php echo e($income && $income['bank'] > 0 ? number_format($income['bank'], 0) : ''); ?></td>
                                    <td class="amount-cell remain-cell fw-bold"><?php echo e($income && $income['remain'] > 0 ? number_format($income['remain'], 0) : ''); ?></td>
                                    
                                    <!-- Expense Side -->
                                    <td class="description-cell ps-3"><?php echo e($expense['description'] ?? ''); ?></td>
                                    <td class="amount-cell"><?php echo e($expense && $expense['mobile'] > 0 ? number_format($expense['mobile'], 0) : ''); ?></td>
                                    <td class="amount-cell text-danger fw-bold"><?php echo e($expense && $expense['cash'] > 0 ? number_format($expense['cash'], 0) : ''); ?></td>
                                    <td class="amount-cell"><?php echo e($expense && $expense['bank'] > 0 ? number_format($expense['bank'], 0) : ''); ?></td>
                                </tr>
                            <?php endfor; ?>

                            <!-- Department Sub-Totals Row -->
                            <tr class="total-row">
                                <td colspan="2" class="fw-bold ps-3" style="text-align: left !important;"><?php echo e($dept->name); ?> TOTALS</td>
                                <td class="amount-cell fw-bold"><?php echo e(number_format($deptTotalIncomeMobile, 0)); ?></td>
                                <td class="amount-cell fw-bold text-success"><?php echo e(number_format($deptTotalIncomeCash, 0)); ?></td>
                                <td class="amount-cell fw-bold"><?php echo e(number_format($deptTotalIncomeBank, 0)); ?></td>
                                <td class="amount-cell fw-bold text-primary"><?php echo e(number_format($deptTotalIncomeRemain, 0)); ?></td>
                                
                                <td class="fw-bold ps-3" style="text-align: left !important;">DEPT CASHOUT</td>
                                <td class="amount-cell fw-bold"><?php echo e(number_format($deptTotalExpenseMobile, 0)); ?></td>
                                <td class="amount-cell fw-bold text-danger"><?php echo e(number_format($deptTotalExpenseCash, 0)); ?></td>
                                <td class="amount-cell fw-bold"><?php echo e(number_format($deptTotalExpenseBank, 0)); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="col-md-6">
                <div class="ps-2">
                    ...
                    <div class="d-flex justify-content-between mb-2 small">
                        ...
                        <span class="fw-bold text-dark">TZS <?php echo e(number_format($totalIn, 0)); ?></span>
                    </div>
                    
                    <div class="d-flex justify-content-between mb-2 small">
                        <span class="text-muted">Total Expenses (Out):</span>
                        <span class="fw-bold text-warning">TZS <?php echo e(number_format($totalOut, 0)); ?></span>
                    </div>
                    
                    <div class="d-flex justify-content-between mb-2 small">
                        <span class="text-muted">Total Outstanding (Remain):</span>
                        <span class="fw-bold text-info">TZS <?php echo e(number_format($grandTotalIncomeRemain, 0)); ?></span>
                    </div>

                    <div class="d-flex justify-content-between mb-2 small">
                        <span class="text-muted">Total Debt Collected:</span>
                        <span class="fw-bold text-success">TZS <?php echo e(number_format($grandTotals['income']['total_debt'], 0)); ?></span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between border-top border-secondary border-opacity-10 pt-3 mt-3 align-items-center">
                        ...
                        <span class="fw-bold fs-5 text-primary">
                            TZS <?php echo e(number_format($net, 0)); ?>
                ...
                <div class="ps-md-5 border-start border-secondary border-opacity-10">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6">
                            ...
                            <div class="fw-bold text-success small">TZS <?php echo e(number_format($grandTotals['income']['cash'], 0)); ?></div>
                        </div>
                        <div class="col-6">
                            <div class="small text-muted mb-1 text-uppercase x-small">Mobile (In)</div>
                            <div class="fw-bold text-primary small">TZS <?php echo e(number_format($grandTotals['income']['mobile'], 0)); ?></div>
                        </div>
                        <div class="col-6">
                            <div class="small text-muted mb-1 text-uppercase x-small">Bank (In)</div>
                            <div class="fw-bold text-info small">TZS <?php echo e(number_format($grandTotals['income']['bank'], 0)); ?></div>
                        </div>
                        <div class="col-6">
                            <div class="small text-muted mb-1 text-uppercase x-small">Total In</div>
                            <div class="fw-bold text-dark small">TZS <?php echo e(number_format($grandTotals['income']['cash'] + $grandTotals['income']['mobile'] + $grandTotals['income']['bank'], 0)); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="pt-2 border-top border-secondary border-opacity-10">
                        ...
                        <div class="d-flex justify-content-between x-small mb-1">
                            ...
                            <span class="text-danger">- TZS <?php echo e(number_format($grandTotals['expense']['cash'], 0)); ?></span>
                        </div>
                        <div class="d-flex justify-content-between x-small mb-1">
                            <span class="text-muted">Mobile:</span>
                            <span>- TZS <?php echo e(number_format($grandTotals['expense']['mobile'], 0)); ?></span>
                        </div>
                        <div class="d-flex justify-content-between x-small mb-1">
                            <span class="text-muted">Bank:</span>
                            <span>- TZS <?php echo e(number_format($grandTotals['expense']['bank'], 0)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Desktop/LaravelProject/chibo_sales/resources/views/admin/finance/daily-report.blade.php ENDPATH**/ ?>