<?php $__env->startSection('title', 'Saler Performance - ' . $saler->name); ?>
...
<div class="container-fluid">
    ...
    <div class="print-only report-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 text-dark">Staff: <?php echo e($saler->name); ?> (<?php echo e($saler->phone); ?>)</p>
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('admin.saler-performance.index')); ?>" class="text-decoration-none">
                    <i class="fas fa-chart-line me-1"></i>Saler Performance
                </a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">
                <?php echo e($saler->name); ?> Analytics
            </li>
        </ol>
    </nav>
    ...
    <div class="mb-4 no-print">
        <div class="d-flex align-items-center justify-content-between mb-2">
            <div class="d-flex align-items-center overflow-hidden">
                ...
                <div class="ms-3 overflow-hidden">
                    <h4 class="mb-0 fw-bold text-truncate"><?php echo e($saler->name); ?></h4>
                </div>
            </div>
            <div class="action-icons d-flex gap-2 ms-2">
                <a href="<?php echo e(route('admin.saler-performance.export', ['type' => 'pdf', 'saler_id' => $saler->id])); ?>" class="text-danger fs-5" data-no-preloader data-no-global-handler title="Download PDF">
                    <i class="fas fa-file-pdf"></i>
                </a>
                <?php $salerShowPdfUrl = route('admin.saler-performance.export', ['type' => 'pdf', 'saler_id' => $saler->id]); ?>
                <a href="<?php echo e($salerShowPdfUrl); ?>" target="_blank" rel="noopener" class="text-success fs-5 share-pdf-btn" data-pdf-url="<?php echo e($salerShowPdfUrl); ?>" data-pdf-filename="saler-<?php echo e($saler->id); ?>-performance.pdf" title="Share PDF">
                    <i class="fas fa-share-alt"></i>
                </a>
                <a href="<?php echo e(route('admin.saler-performance.export', ['type' => 'excel', 'saler_id' => $saler->id])); ?>" class="text-success fs-5" data-no-preloader data-no-global-handler title="Export Excel">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="text-muted x-small">
                ...
                <i class="fas fa-phone me-1"></i><?php echo e($saler->phone); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge <?php echo e($order->approval_status == 'approved' ? 'bg-success' : ($order->approval_status == 'cancelled' ? 'bg-danger' : 'bg-warning')); ?> rounded-pill">
                                            <?php echo e(ucfirst($order->approval_status)); ?>
                        ...
                        <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($task->customer->name ?? 'N/A'); ?></td>
                                    <td class="text-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const salerId = <?php echo e($saler->id); ?>;
    ...
    async function updateCharts() {
        ...
        const url = `<?php echo e(route('admin.saler-performance.chart-data')); ?>?timeframe=${timeframe}&saler_id=${salerId}`;
    ...
    window.onbeforeprint = () => { document.title = "Saler_Performance_<?php echo e($saler->name); ?>_<?php echo e(now()->format('Ymd')); ?>"; };
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/admin/saler-performance/show.blade.php ENDPATH**/ ?>