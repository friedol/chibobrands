<?php $__env->startSection('page-title', 'SMS Configuration'); ?>
        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-3">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.settings.sms.update')); ?>" id="smsSettingsForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" 
                                       class="form-control <?php $__errorArgs = ['api_secret'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" 
                                   class="form-control <?php $__errorArgs = ['api_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (diagnoseSmsBtn) {
        diagnoseSmsBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("admin.settings.sms.diagnose")); ?>', {
                method: 'GET',
                headers: {
    ...
    if (clearConfigCacheBtn) {
        clearConfigCacheBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("admin.settings.sms.update")); ?>', {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json',
    ...
    if (sendTestSmsBtn) {
        sendTestSmsBtn.addEventListener('click', function() {
            ...
            // Send AJAX request
            fetch('<?php echo e(route("admin.settings.sms.test")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/admin/settings/sms.blade.php ENDPATH**/ ?>