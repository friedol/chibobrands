<?php $__env->startSection('title', 'Customer Data Center - Predictive Sales'); ?>
    ...
    <div class="row align-items-center mb-4 g-3">
        ...
        <div class="col-md-6 d-flex justify-content-md-end align-items-center gap-2">
            <div class="btn-group p-1 bg-light rounded-pill shadow-sm">
                <a href="<?php echo e(route('admin.customer-data-center.index', ['status' => 'due'])); ?>" 
                   class="btn btn-sm rounded-pill px-3 <?php echo e($statusFilter == 'due' ? 'btn-primary shadow-sm' : 'btn-light border-0'); ?> x-small fw-bold">
                    DUE TODAY / OVERDUE
                </a>
                <a href="<?php echo e(route('admin.customer-data-center.index', ['status' => 'upcoming'])); ?>" 
                   class="btn btn-sm rounded-pill px-3 <?php echo e($statusFilter == 'upcoming' ? 'btn-primary shadow-sm' : 'btn-light border-0'); ?> x-small fw-bold">
                    UPCOMING
                </a>
                <a href="<?php echo e(route('admin.customer-data-center.index', ['status' => 'new'])); ?>" 
                   class="btn btn-sm rounded-pill px-3 <?php echo e($statusFilter == 'new' ? 'btn-primary shadow-sm' : 'btn-light border-0'); ?> x-small fw-bold">
                    NEW CUSTOMERS
                </a>
            </div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card shadow-sm h-100 border-0 border-start border-4 border-danger hover-lift">
                <div class="card-body p-3">
                    ...
                    <div class="h3 mb-0 fw-bold text-dark"><?php echo e(number_format($stats['overdue'])); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card shadow-sm h-100 border-0 border-start border-4 border-warning hover-lift">
                <div class="card-body p-3">
                    ...
                    <div class="h3 mb-0 fw-bold text-dark"><?php echo e(number_format($stats['due_today'])); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card shadow-sm h-100 border-0 border-start border-4 border-primary hover-lift">
                <div class="card-body p-3">
                    ...
                    <div class="h3 mb-0 fw-bold text-dark"><?php echo e(number_format($stats['upcoming'])); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card shadow-sm h-100 border-0 border-start border-4 border-success hover-lift">
                <div class="card-body p-3">
                    ...
                    <div class="h3 mb-0 fw-bold text-dark"><?php echo e(number_format($stats['total_customers'])); ?></div>
                    ...
                    <tr class="border-bottom border-light">
                        <td class="ps-4 py-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                >
                                <div>
                                    <h6 class="fw-bold mb-1 text-dark"><?php echo e($customer->name); ?></h6>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="text-muted x-small"><i class="fas fa-phone-alt me-1"></i><?php echo e($customer->phone); ?></span>
                                        <?php if($customer->company_name): ?>
                                            <span class="badge bg-light text-primary x-small border-0 px-2"><?php echo e($customer->company_name); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            <span class="badge rounded-pill px-3 py-2 bg-<?php echo e($customer->status_color); ?>-subtle text-<?php echo e($customer->status_color); ?> x-small fw-bold text-uppercase border-0">
                                <?php echo e($customer->follow_up_status); ?>

                            </span>
                        </td>
                        <td>
                            <?php if($customer->avg_reorder_interval): ?>
                                <div class="fw-bold text-dark small"><?php echo e(number_format($customer->avg_reorder_interval, 1)); ?> Days</div>
                        ...
                        <td>
                            ...
                            ?>
                            <?php if($nextDate): ?>
                                <div class="fw-bold <?php echo e($nextDate->isPast() ? 'text-danger' : 'text-dark'); ?> small">
                                    <?php echo e($nextDate->format('M d, Y')); ?>

                                </div>
                                <div class="extra-small text-muted d-flex align-items-center">
                                    <?php echo e($nextDate->diffForHumans()); ?>

                                    <?php if($customer->manual_follow_up_date && $customer->manual_follow_up_date->isFuture()): ?>
                            ...
                            <div class="d-flex align-items-center gap-2" style="max-width: 120px;">
                                <div class="progress flex-grow-1" style="height: 4px;">
                                    <div class="progress-bar bg-primary shadow-sm" role="progressbar" 
                                         style="width: <?php echo e(min(100, $customer->priority_ranking / 3)); ?>%"></div>
                                </div>
                                <span class="fw-bold x-small text-dark">#<?php echo e($customer->priority_ranking); ?></span>
                            </div>
                        </td>
                        <td class="pe-4 text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3">
                                    <li>
                                        <a href="<?php echo e(route('admin.customer-data-center.show', $customer)); ?>" class="dropdown-item py-2 px-3 small">
                                            <i class="fas fa-chart-line me-2 text-primary"></i>View Insights
                                        </a>
                                    </li>
                                    <li>
                                        <button type="button" class="dropdown-item py-2 px-3 small" data-bs-toggle="modal" data-bs-target="#followUpModal<?php echo e($customer->id); ?>">
                                            <i class="fab fa-whatsapp me-2 text-success"></i>Direct Contact
                                        </button>
                                    </li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <a href="<?php echo e(route('admin.customers.show', $customer->id)); ?>" class="dropdown-item py-2 px-3 small">
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div class="py-5">
                                ...
                                <a href="<?php echo e(route('admin.customer-data-center.index', ['status' => 'all'])); ?>" class="btn btn-sm btn-primary rounded-pill px-4 mt-2">VIEW ALL CUSTOMERS</a>
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
...
<?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="followUpModal<?php echo e($customer->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="modal-header bg-light border-0 py-3 px-4">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fab fa-whatsapp text-success me-2"></i>Smart Contact: <?php echo e($customer->name); ?>
                    ...
                    <div class="modal-body p-4">
                        <div class="d-flex align-items-center gap-3 mb-4 p-3 bg-success bg-opacity-10 rounded-4">
                            ...
                            <div>
                                ...
                                <div class="extra-small text-muted">Automated connection to <?php echo e($customer->phone); ?></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gotlaptopparts.com/Downloads/chibo_sales/resources/views/admin/customers/data-center/index.blade.php ENDPATH**/ ?>