                    ...
                    <div class="login-content">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="login-form">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="email" class="modern-input @error('email') is-invalid @enderror" id="email"
                            ...
                            @if(session('unverified_customer'))
                                <div class="warning-alert">
                                    ...
                                    <div>
                                        ...
                                        Hello <strong>{{ session('unverified_customer')['name'] }}</strong>, your account is
                        ...
                        <div class="register-link">
                            ...
                            <a href="{{ route('customer.register') }}" class="create-account-btn">
