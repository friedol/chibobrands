...
<body>
    ...
    <div class="no-print py-1 px-3 bg-danger text-white d-flex justify-content-between align-items-center mb-3">
        <small class="fw-semibold"><i class="fas fa-print me-1"></i> EXPENSE LOG PRINT PREVIEW</small>
    ...
    <div class="log-wrapper">
        ...
        <div class="meta-container">
            ...
            <div class="text-end">
                ...
                <div class="small">
                    <strong>Total Expenses:</strong> {{ $expenses->count() }} records<br>
                    <strong>Grand Total:</strong> TZS {{ number_format($expenses->sum('amount')) }}
                </div>
            </div>
        </div>
        ...
        <table class="table-pro">
            ...
            <tbody>
                @foreach($expenses as $expense)
                    <tr>
                        <td>
                            <div class="fw-bold">{{ $expense->date->format('d/m/Y') }}</div>
                        </td>
                        <td>
                            <div class="fw-bold text-uppercase" style="font-size: 7.5pt;">{{ $expense->category }}</div>
                        </td>
                        <td>
                            <div>{{ $expense->department->name ?? 'General' }}</div>
                        </td>
                        <td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-end fw-bold" style="background-color: #f8f8f8;">{{ number_format($expenses->sum('amount')) }}</td>
                </tr>
            </tfoot>
        </table>
