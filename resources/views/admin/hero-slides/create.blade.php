    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <i class="fas fa-plus me-1"></i>Create New Slide
            </li>
        </ol>
    </nav>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                @if($isAd)
                    Add a new advertisement to your website
                @else
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.hero-slides.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('page_type') is-invalid @enderror" 
                                        ...
                                        <option value="all" {{ old('page_type') == 'all' ? 'selected' : '' }}>All Pages</option>
                                        <!--<option value="homepage" {{ old('page_type') == 'homepage' ? 'selected' : '' }}>Homepage Only</option>-->
                                        <option value="services" {{ old('page_type') == 'services' ? 'selected' : '' }}>Retail Services</option>
                                        <option value="products" {{ old('page_type') == 'products' ? 'selected' : '' }}>Retail Homepage</option>
                                        <option value="wholesale_services" {{ old('page_type') == 'wholesale_services' ? 'selected' : '' }}>Wholesale Services </option>
                                        <option value="wholesale_homepage" {{ old('page_type') == 'wholesale_homepage' ? 'selected' : '' }}>Wholesale Homepage</option>
                                    </select>
                                    @error('page_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Background Media <span class="text-danger">*</span></label>
                            <input type="file" 
                        ...
                        @if($isAd)
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h6 class="mb-0 text-white"><i class="fas fa-ad me-2"></i>Advertisement Settings</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('ad_position') is-invalid @enderror" 
                                                    ...
                                                    <option value="bottom" {{ old('ad_position') == 'bottom' ? 'selected' : '' }}>Bottom</option>
                                                    ...
                                                    <option value="center" {{ old('ad_position') == 'center' ? 'selected' : '' }}>Center</option>
                                                </select>
                                                @error('ad_position')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('ad_target_audience') is-invalid @enderror" 
                                                    ...
                                                    <option value="all" {{ old('ad_target_audience') == 'all' ? 'selected' : '' }}>All Users</option>
                                                    <option value="retail" {{ old('ad_target_audience') == 'retail' ? 'selected' : '' }}>Retail Customers</option>
                                                    <option value="wholesale" {{ old('ad_target_audience') == 'wholesale' ? 'selected' : '' }}>Wholesale Customers</option>
                                                    <option value="new_customers" {{ old('ad_target_audience') == 'new_customers' ? 'selected' : '' }}>New Customers</option>
                                                    <option value="returning_customers" {{ old('ad_target_audience') == 'returning_customers' ? 'selected' : '' }}>Returning Customers</option>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       value="{{ old('ad_cost_per_impression') }}" 
                                                       min="0" 
                                                       step="0.01">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn {{ $isAd ? 'btn-warning' : 'btn-danger' }}" data-no-global-handler>
                                <i class="fas fa-save me-2"></i>Create {{ $isAd ? 'Ad' : 'Slide' }}
                            </button>
                            <a href="{{ route('admin.hero-slides.index') }}" class="btn btn-outline-secondary">
                                Cancel
                            </a>
                ...
                <div class="card-body">
                    <div id="slide-preview" class="hero-preview">
                        <div class="hero-preview-content">
                            <h3 id="preview-title">Slide Title</h3>
                            <p id="preview-subtitle">Slide subtitle will appear here</p>
