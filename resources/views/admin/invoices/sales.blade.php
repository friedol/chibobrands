...
<head>
    ...
    <title>Sales Invoice - {{ $order->order_code }}</title>
...
<body>
    ...
    <div class="no-print py-1 px-3 bg-primary text-white d-flex justify-content-between align-items-center mb-3">
        <small class="fw-semibold"><i class="fas fa-print me-1"></i> SALES INVOICE PREVIEW</small>
        ...
        <div class="header-section">
            ...
            <div class="invoice-header-title">
                ...
                <div class="balance-due-header-box">
                    ...
                    <div class="amount">TZS {{ number_format($order->balance, 2) }}</div>
                </div>
            </div>
        </div>
