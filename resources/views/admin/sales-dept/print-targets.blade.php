...
<body>
    ...
    <div class="no-print p-3 bg-dark text-white d-flex justify-content-between align-items-center mb-4">
        <div class="ms-2">
            <h6 class="mb-0 fw-bold"><i class="fas fa-print me-2"></i> SALES TARGETS PRINT PREVIEW</h6>
        </div>
        <div class="me-2">
        ...
        <div class="report-header">
            <div class="row align-items-end">
                ...
                <div class="col-5 text-end">
                    <h2 class="report-title">Sales Targets Report</h2>
        ...
        <div class="meta-container">
            ...
            <div class="text-end">
                ...
                <div class="small">
                    ...
                    <strong>Grand Total Target:</strong> TZS {{ number_format($targets->sum('target_amount')) }}
                </div>
            </div>
        </div>
        ...
        <table class="table-pro">
            <thead>
                <tr>
                    ...
                    <th>START DATE</th>
                    <th>END DATE</th>
                    <th style="width: 120px;" class="text-end">TARGET AMOUNT (TZS)</th>
                </tr>
            </thead>
            <tbody>
                @foreach($targets as $target)
                    <tr>
                        <td>
                            <div class="fw-bold">{{ $target->seller->name ?? 'Unknown' }}</div>
                        </td>
                        <td>
                            <div>{{ $target->department->name ?? 'General' }}</div>
                        </td>
                        <td class="text-center text-uppercase" style="font-size: 7.5pt;">
                            {{ $target->period }}
                        </td>
                        <td>
            ...
            <tfoot>
                <tr>
                    <td colspan="5" class="text-end fw-bold text-uppercase" style="font-size: 7.5pt; background-color: #f8f8f8;">Total Pipeline Target</td>
                    <td class="text-end fw-bold" style="background-color: #f8f8f8;">{{ number_format($targets->sum('target_amount')) }}</td>
                </tr>
            </tfoot>
        </table>
