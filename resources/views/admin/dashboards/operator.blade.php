    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <span class="badge bg-dark px-3 py-2 rounded-pill x-small">
                            <i class="fas fa-print me-1"></i> Production Mode
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="m-0 fw-bold text-dark"><i class="fas fa-chart-line me-2 text-primary"></i>
                            {{ match ($period ?? 'month') {
        'today' => 'Production Flow by Hour',
        'week' => 'Production Trend (Last 7 Days)',
        'month' => 'Production Trend (Last 30 Days)',
        '2_years' => 'Monthly Production (24 Months)',
        default => 'Production Trend'
    } }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div style="height: 300px;">
                            <canvas id="operatorOutputChart"></canvas>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="m-0 fw-bold text-dark"><i class="fas fa-chart-pie me-2 text-info"></i>Status Distribution
                        </h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="m-0 fw-bold text-dark"><i class="fas fa-chart-bar me-2 text-success"></i>
                            {{ match ($period ?? 'month') {
        'today' => 'Production Volume by Hour',
        'week' => 'Production Volume (Last 7 Days)',
        'month' => 'Production Volume (Last 30 Days)',
        '2_years' => 'Monthly Production Volume (Last 24 Months)',
        default => 'Monthly Production Volume'
    } }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div style="height: 250px;">
                            <canvas id="operatorMonthlyBarChart"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="m-0 fw-bold text-dark"><i class="fas fa-tasks me-2"></i>Recent Work Units</h6>
                    </div>
                    <div class="card-body p-0">
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light">
                                    <tr class="x-small text-uppercase fw-bold text-muted">
                                        <th class="ps-3 border-0">Job Title</th>
                                        <th class="border-0">Customer</th>
                                        <th class="border-0">Status</th>
                                        <th class="text-end pe-3 border-0">Time</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($recentTasks as $task)
                                                                    <tr>
                                                                        <td class="ps-3">
                                                                            <div class="small fw-bold text-dark">{{ Str::limit($task->title, 40) }}</div>
                                                                        </td>
                                            ...
                                            'printing' => 'dark'
                                                                        ...
                                                                        <td class="text-end pe-3 x-small text-muted">
                                                                            {{ $task->created_at->diffForHumans() }}</td>
                                                                    </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center py-5 text-muted small">No recent work units found
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                // Output Trend Chart
                const ctxTrend = document.getElementById('operatorOutputChart').getContext('2d');
                new Chart(ctxTrend, {
                    type: 'line',
                    data: {
                ...
                const ctxStatus = document.getElementById('operatorStatusChart').getContext('2d');
                ...
                const ctxBar = document.getElementById('operatorMonthlyBarChart').getContext('2d');
                new Chart(ctxBar, {
                    type: 'bar',
                    data: {
