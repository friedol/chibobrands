...
@section('title', 'Contact Us - CHIBO BRAND')
@section('description', 'Let’s talk about your next project. Contact CHIBO BRAND for designing, printing, and branding services.')
...
<style>
    ...
    @media (max-width: 768px) {
        .hero-banner{padding:40px 0;min-height:250px}
        .hero-content{padding:1rem}
        .hero-title{font-size:clamp(20px,5vw,28px);margin-bottom:0.75rem}
        .hero-subtitle{font-size:clamp(12px,3vw,14px);margin-bottom:1rem}
        .hero-cta-btn{padding:10px 20px;font-size:12px}
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mt-3 mt-lg-0">
                <div class="card p-3 h-100">
                    <h5 class="fw-bold">Our Working Hours</h5>
