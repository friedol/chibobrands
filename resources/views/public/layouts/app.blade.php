...
<head>
    ...
    <title>@yield('title', 'CHIBO BRAND - Professional Printing & Branding Solutions')</title>
    <meta name="description"
        content="@yield('description', 'CHIBO BRAND offers professional printing and branding solutions. Quality products, competitive prices, and excellent customer service.')">
    <meta name="keywords"
    ...
    <meta property="og:title" content="@yield('title', 'CHIBO BRAND - Professional Printing & Branding Solutions')">
    <meta property="og:description"
        content="@yield('description', 'CHIBO BRAND offers professional printing and branding solutions.')">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:image" content="{{ asset('images/chibo-brand-logo.png') }}">

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="@yield('title', 'CHIBO BRAND')">
    <meta name="twitter:description" content="@yield('description', 'Professional Printing & Branding Solutions')">
    <!-- Favicon -->
...
if ($salerParam) {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            ...
            <div class="d-flex align-items-center gap-1 d-lg-none ms-auto position-static">
                ...
                @else
                    <a class="btn btn-link p-1 text-danger" href="{{ route('login') }}" aria-label="Login or register">
                        ...
                        @auth('customer')
                            <div class="nav-item dropdown d-flex align-items-center mb-0 mt-0">
                                <a class="nav-link dropdown-toggle d-flex align-items-center text-dark m-0 p-0" href="#"
                                    ...
                                    <i
                                        class="fas fa-user me-2"></i>{{ explode(' ', Auth::guard('customer')->user()->name)[0] }}
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2">
                                    @if($channel === 'wholesale')
                                        <li><a class="dropdown-item" href="{{ route('b2b.customer.dashboard') }}">Home</a></li>
                                        <li><a class="dropdown-item" href="{{ route('b2b.customer.profile') }}">Profile</a></li>
                                        <li><a class="dropdown-item" href="{{ route('b2b.customer.orders.index') }}">Orders</a>
                                        </li>
                                    @else
                                        <li><a class="dropdown-item"
                                                href="{{ route('retail.customer.dashboard') }}">Dashboard</a></li>
                                        <li><a class="dropdown-item" href="{{ route('retail.customer.profile') }}">Profile</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('retail.customer.orders.index') }}">Orders</a></li>
                                    @endif
                                    <li>
                                    ...
                                    <li>
                                        <form
                                            action="{{ $channel === 'wholesale' ? route('b2b.customer.logout') : route('retail.customer.logout') }}"
        ...
        <div class="mobile-sidebar-content">
            ...
            <div class="mobile-sidebar-body">
                <nav class="nav flex-column">
                    <!-- Main Navigation Links -->
                    <a class="nav-link"
                        href="{{ $channel === 'wholesale' ? url('/b2b/our-brand') : url('/our-brand') }}"
                        onclick="closeMobileSidebar()">
                        <i class="fas fa-building"></i>Our Brand
                    </a>
                    <a class="nav-link" href="{{ url($prefix . '/') }}" onclick="closeMobileSidebar()">
                        <i class="fas fa-home"></i>Home
                    </a>
                    <a class="nav-link"
                        href="{{ $channel === 'wholesale' ? route('wholesale.products.index') : url($prefix . '/products') }}"
                        onclick="closeMobileSidebar()">
                        <i class="fas fa-box"></i>Products
                    </a>
                    <a class="nav-link"
                        href="{{ $channel === 'wholesale' ? route('wholesale.categories.index') : url($prefix . '/categories') }}"
                        onclick="closeMobileSidebar()">
                        <i class="fas fa-tags"></i>Categories
                    </a>
                    <a class="nav-link" href="{{ $channel === 'wholesale' ? url('/b2b/services') : url('/services') }}"
                        onclick="closeMobileSidebar()">
                        <i class="fas fa-cogs"></i>Services
                    </a>
                    <a class="nav-link" href="{{ $channel === 'wholesale' ? url('/b2b/about') : url('/about') }}"
                        onclick="closeMobileSidebar()">
                        <i class="fas fa-info-circle"></i>About
                    </a>
                    <a class="nav-link" href="{{ $channel === 'wholesale' ? url('/b2b/contact') : url('/contact') }}"
                        onclick="closeMobileSidebar()">
                    ...
                    @auth('customer')
                        ...
                        <div class="nav-link text-muted small mb-2">
                            ...
                            <span
                                class="badge {{ Auth::guard('customer')->user()->is_wholesale ? 'bg-warning' : 'bg-info' }} ms-2">
                                {{ Auth::guard('customer')->user()->is_wholesale ? 'Wholesale' : 'Retail' }}
                            </span>
                        </div>

                        <!-- Account Navigation Links -->
                        @if($channel === 'wholesale')
                            <a class="nav-link" href="{{ route('b2b.customer.dashboard') }}" onclick="closeMobileSidebar()">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                            </a>
                            <a class="nav-link" href="{{ route('b2b.customer.profile') }}" onclick="closeMobileSidebar()">
                                <i class="fas fa-user-edit"></i>Profile
                            </a>
                            <a class="nav-link" href="{{ route('b2b.customer.orders.index') }}" onclick="closeMobileSidebar()">
                                <i class="fas fa-shopping-bag"></i>Orders
                            </a>
                        @else
                            <a class="nav-link" href="{{ route('retail.customer.dashboard') }}" onclick="closeMobileSidebar()">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                            </a>
                            <a class="nav-link" href="{{ route('retail.customer.profile') }}" onclick="closeMobileSidebar()">
                                <i class="fas fa-user-edit"></i>Profile
                            </a>
                            <a class="nav-link" href="{{ route('retail.customer.orders.index') }}"
                                onclick="closeMobileSidebar()">
                                <i class="fas fa-shopping-bag"></i>Orders
                            </a>
                        @endif
                    ...
                    @else
                        <a class="nav-link" href="{{ route('login') }}" onclick="closeMobileSidebar()">
                            <i class="fas fa-sign-in-alt"></i>Login
                        </a>
                        <a class="nav-link" href="{{ route('customer.register') }}" onclick="closeMobileSidebar()">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-12 text-center text-lg-start">
                    <div class="footer-brand-section">
                        ...
                        <div class="social-links d-flex justify-content-center justify-content-lg-start gap-3 mb-3">
                            ...
                            <a href="https://wa.me/{{ $dynamicWhatsapp }}" target="_blank" class="social-icon"><i
                ...
                <div class="col-lg-2 col-md-6 d-none d-md-block">
                    ...
                    <ul class="list-unstyled footer-links">
                        <li><a href="{{ url($prefix . '/') }}"><i class="fas fa-chevron-right me-2"></i>Home</a></li>
                        <li><a href="{{ url($prefix . '/products') }}"><i
                                    class="fas fa-chevron-right me-2"></i>Products</a></li>
                        <li><a href="{{ url($prefix . '/categories') }}"><i
    ...
    <a href="https://wa.me/{{ $dynamicWhatsapp }}?text=Hello%20CHIBO%20BRAND%20👋,%20I%20would%20like%20to%20know%20more%20about%20your%20services."
    ...
    <script>
        window.chiboConfig = {
            dynamicWhatsapp: @json($dynamicWhatsapp),
