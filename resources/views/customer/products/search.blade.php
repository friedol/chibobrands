...
@section('title', 'Search Results - CHIBO BRAND B2B')
@section('description', 'Search results for CHIBO BRAND wholesale products.')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        @if($query)
            <p class="text-muted mb-0">Showing results for: <strong>"{{ $query }}"</strong></p>
        @endif
    </div>
    <div>
...
<div class="card mb-4">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-8">
                <form method="GET" action="{{ route('customer.products.search') }}" class="d-flex">
                    <input type="text" name="q" class="form-control me-2" placeholder="Search wholesale products..." value="{{ $query }}">
...
@if($products->count() > 0)
    <div class="row mb-4">
        <div class="col-12">
            <p class="text-muted">Found {{ $products->total() }} wholesale product(s)</p>
        </div>
    </div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <span class="price-wholesale h6 mb-0">${{ number_format($product->base_price * 0.8, 2) }}</span>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                @if($product->availability !== 'out_of_stock')
                                    <button type="button" 
                                            ...
                                            data-product-price="{{ $product->base_price * 0.8 }}">
...
@else
    <div class="text-center py-5">
        ...
        <p class="text-muted">
            @if($query)
                We couldn't find any wholesale products matching "{{ $query }}". Try different keywords or browse our categories.
            @else
                No wholesale products found for the selected criteria.
            @endif
        </p>
        <div class="d-flex justify-content-center gap-3">
            ...
            <a href="{{ route('customer.categories.index') }}" class="btn btn-outline-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add to cart functionality (same as wholesale index page)
